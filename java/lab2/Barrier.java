...
public class Barrier implements Platform{
	/** 
	 * Creates barrier.
	 * @param initLeftTopX - x coordinate of left top corner of barrier.
	 * @param initLeftTopY - y coordinate of left top corner of barrier.
	 * @param initRightBotX - x coordinate of rigth bottom corner of barrier.
	 * @param initRigthBotY - y coordinate of right bottom corner of barrier.
